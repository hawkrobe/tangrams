...
TODO: examine reduction in # words in noun phrases, i.e. to argue that it's not just small-talk going down or something
...
### Reduction in different parts of speech

TODO: fix this code block to use right names...
...
TODO: need to use combined tangrams data from R, not one with python nlp features
