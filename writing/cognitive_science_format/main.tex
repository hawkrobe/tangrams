...
In this task, pairs of participants are presented with arrays of novel objects. 
...
Second, the resulting conventions are \emph{partner-specific} in the sense that they do not transfer if a novel matcher is introduced \citep{WilkesGibbsClark92_CoordinatingBeliefs,MetzingBrennan03_PartnerSpecificPacts,brennan_partner-specific_2009}.
Third, they are \emph{sticky} in the sense that they persist through precedent with the same partner even after the set of objects changes \citep{BrennanClark96_ConceptualPactsConversation}.
