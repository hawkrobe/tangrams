...
We used a 66/66 rule, excluding pairs that got fewer than 66\% of the tangrams \ndg{items? trials?} correct ($\ge8$ of 12) \ndg{this is the exlcusion criteria, so should it be less than 8?} on more than 66\% of blocks ($\ge4$ of 6). 
...
In this paper, we characterized the dynamics of this process in a classic repeated reference game.
