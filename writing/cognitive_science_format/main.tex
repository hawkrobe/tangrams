...
Taken together, these qualitative effects provide an empirical backbone that theories of adaptation, common ground, and conventionalization must explain.
However, as these theories are increasingly formalized as computational models that aim to make precise quantitative predictions, model comparison will depend critically upon a finer-grained characterization of the dynamics of adaptation.
Certain fundamental questions about the data remain unanswered, and important theoretical constructs remain poorly operationalized. 
The computational techniques necessary to provide such a characterization of rich natural language data were limited at the time of prior work, but have become newly tractable given developments in natural language processing (NLP).
In this paper, rather than arguing for a particular theory, we release a large corpus of repeated reference games and conduct a variety of analyses with the aim of establishing a firmer foundation for future model development.
...
For example, a precise characterization which parts of utterances are shortened, and how, has remained elusive.
