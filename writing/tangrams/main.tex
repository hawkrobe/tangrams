...
An influential result from \citet[see also \citealp{KraussWeinheimer66_Tangrams, GarrodFayLeeOberlanderMacLeod07_GraphicalSymbolSystems}]{clarkReferringCollaborativeProcess1986} is that ad hoc conventions for referring are established \emph{collaboratively}: 
