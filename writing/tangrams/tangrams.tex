...
In this paper, we investigate three key empirical signatures constraining theories of convention formation in such contexts: arbitrariness, stability, and increasing efficiency over time. 
...
In sum, this work clarifies the dynamics of rapid semantic coordination and lays the empirical foundation for higher-resolution computational modeling.
\end{abstract}
